...
for item in (
    ...
    _metadata(
        ...
        label="Retrieval round routing",
        description="Dispatch validated local and web tasks for one bounded evidence round.",
        role="router",
        group="evidence",
        stage_rank=38,
        order=38,
    ...
    _metadata(
        ...
        label="Local evidence batch",
        description="Execute requirement-bound local retrieval tasks for one evidence round.",
        role="retrieval",
        group="evidence",
        stage_rank=40,
        order=41,
    ...
    _metadata(
        ...
        label="Web evidence batch",
        description="Execute requirement-bound web retrieval tasks for one evidence round.",
        role="retrieval",
        group="evidence",
        stage_rank=40,
        order=42,
    ...
    _metadata(
        ...
        label="Evidence round merge",
        description="Merge and exactly deduplicate local and web evidence batch results.",
        role="retrieval",
        group="evidence",
        stage_rank=45,
        order=45,
    ...
    _metadata(
        ...
        label="Requirement coverage judge",
        description="Judge coverage for every compiled resource evidence requirement.",
        role="judge",
        group="evidence",
        stage_rank=50,
        order=51,
    ...
    _metadata(
        ...
        label="Evidence repair planning",
        description="Plan bounded targeted searches for unresolved evidence requirements.",
        role="planner",
        group="evidence",
        stage_rank=52,
        order=52,
    ...
    _metadata(
        ...
        label="Parent evidence hydration",
        description="Hydrate kept child evidence with parent context after terminal judging.",
        role="retrieval",
        group="evidence",
        stage_rank=54,
        order=54,
    ...
    _metadata(
        ...
        label="Academic parent hydration",
        description="Hydrate judged academic child evidence with bounded parent context.",
        role="retrieval",
        group="evidence",
        stage_rank=54,
        order=54,
    ...
    _metadata(
        ...
        label="Resource parent hydration",
        description="Hydrate terminal resource evidence with requirement-bound parent context.",
        role="retrieval",
        group="evidence",
        stage_rank=54,
        order=55,
    ...
    _metadata(
        ...
        label="Resource evidence assignment",
        description="Assign approved evidence and readiness independently to each resource.",
        role="planner",
        group="evidence",
        stage_rank=56,
        order=56,
    ...
    _metadata(
        ...
        description="Retrieve child evidence from the active generation for later parent hydration.",
        role="retrieval",
        group="retrieval",
        stage_rank=40,
        order=40,
    ...
    _metadata(
        "web_research",
        label="Web research",
        description="Collect web evidence candidates through the strict Web Research V2 boundary.",
        role="retrieval",
        group="retrieval",
        stage_rank=40,
        order=45,
